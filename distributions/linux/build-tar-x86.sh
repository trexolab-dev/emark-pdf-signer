#!/bin/bash
# ============================================================================
# eMark PDF Signer - Portable TAR.GZ Package Builder (x86/i386)
...
#
# Output:
#   ./output/emark-pdf-signer-x86-linux.tar.gz
# ============================================================================
...
echo "============================================================================"
echo " Building eMark PDF Signer Portable Package (tar.gz) - x86/i386"
echo "============================================================================"
...
cp "$SCRIPT_DIR/emark-x86" "$PACKAGE_DIR/emark"
...
#!/bin/bash
# ============================================================================
# eMark PDF Signer - Linux Installation Script (x86/i386)
# TrexoLab - https://trexolab.com
# ============================================================================
...
echo ""
echo -e "${BLUE}============================================================================${NC}"
echo -e "${BLUE} eMark PDF Signer Installation Script (x86/i386)${NC}"
echo -e "${BLUE}============================================================================${NC}"
echo ""
...
if [ -n "$INSTALLED_VERSION" ]; then
    ...
    echo " Installing eMark PDF Signer $NEW_VERSION (x86/i386)..."
fi
...
echo ""
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN} eMark PDF Signer $NEW_VERSION (x86/i386) has been installed successfully!${NC}"
echo -e "${GREEN}============================================================================${NC}"
echo ""
echo " Launch from:"
...
============================================================================
 eMark PDF Signer - Portable Linux Package (x86/i386 - 32-bit)
 TrexoLab - https://trexolab.com
============================================================================
...
Option 1: Using the install script (recommended)
   tar -xzf emark-pdf-signer-x86-linux.tar.gz
   cd emark-pdf-signer-*
   sudo ./install.sh

Option 2: Manual extraction
   tar -xzf emark-pdf-signer-x86-linux.tar.gz -C /opt/
...
cd "$BUILD_DIR"
tar -czf "$OUTPUT_DIR/${APP_NAME}-x86-linux.tar.gz" "${APP_NAME}-${APP_VERSION}"
...
echo "============================================================================"
echo " Output: $OUTPUT_DIR/${APP_NAME}-x86-linux.tar.gz"
echo " Size: $(du -h "$OUTPUT_DIR/${APP_NAME}-x86-linux.tar.gz" | cut -f1)"
echo "============================================================================"
