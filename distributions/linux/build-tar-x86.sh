...
cd "$BUILD_DIR"
tar -czf "$OUTPUT_DIR/emark-x86-linux.tar.gz" "${APP_NAME}-${APP_VERSION}"
...
echo "============================================================================"
echo " Output: $OUTPUT_DIR/emark-x86-linux.tar.gz"
echo " Size: $(du -h "$OUTPUT_DIR/emark-x86-linux.tar.gz" | cut -f1)"
echo "============================================================================"
