...
mkdir -p "$OUTPUT_DIR"
dpkg-deb --build --root-owner-group "$PACKAGE_DIR" "$OUTPUT_DIR/emark-x64.deb"
...
echo "============================================================================"
echo " Output: $OUTPUT_DIR/emark-x64.deb"
echo ""
echo " Package info:"
dpkg-deb --info "$OUTPUT_DIR/emark-x64.deb"
echo ""
echo " To install: sudo dpkg -i $OUTPUT_DIR/emark-x64.deb"
echo "============================================================================"