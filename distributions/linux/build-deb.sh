#!/bin/bash
# ============================================================================
# eMark PDF Signer - DEB Package Builder Script
...
#
# Output:
#   ./output/emark-pdf-signer-x64.deb
# ============================================================================
...
echo "============================================================================"
echo " Building eMark PDF Signer DEB Package"
echo "============================================================================"
...
cp "$SCRIPT_DIR/emark" "$PACKAGE_DIR/opt/emark-pdf-signer/"
chmod +x "$PACKAGE_DIR/opt/emark-pdf-signer/emark"

# Copy JRE
echo "Copying bundled JRE..."
cp -r "$SCRIPT_DIR/jre8-x64" "$PACKAGE_DIR/opt/emark-pdf-signer/"
chmod +x "$PACKAGE_DIR/opt/emark-pdf-signer/jre8-x64/bin/"*
...
if [ -n "\$INSTALLED_VERSION" ]; then
    echo ""
    echo "============================================================================"
    echo " eMark PDF Signer Installation Check"
    echo "============================================================================"
...
echo ""
echo "============================================================================"
echo " eMark PDF Signer $APP_VERSION has been installed successfully!"
echo "============================================================================"
echo ""
echo " Launch from:"
...
mkdir -p "$OUTPUT_DIR"
dpkg-deb --build --root-owner-group "$PACKAGE_DIR" "$OUTPUT_DIR/${APP_NAME}-x64.deb"
...
echo "============================================================================"
echo " Output: $OUTPUT_DIR/${APP_NAME}-x64.deb"
echo ""
echo " Package info:"
dpkg-deb --info "$OUTPUT_DIR/${APP_NAME}-x64.deb"
echo ""
echo " To install: sudo dpkg -i $OUTPUT_DIR/${APP_NAME}-x64.deb"
echo "============================================================================"