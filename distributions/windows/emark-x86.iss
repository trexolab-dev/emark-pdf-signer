; ============================================================================
; eMark PDF Signer - Windows x86 (32-bit) Installer Script
...
; Per-machine: C:\Program Files (x86)\TrexoLab\eMark PDF Signer
DefaultDirName={autopf32}\TrexoLab\eMark PDF Signer
DefaultGroupName={#MyAppName}
DisableProgramGroupPage=yes

; Installer output settings
OutputDir=Output
OutputBaseFilename=emark-pdf-signer-x86-setup
...
Source: "run-emark-installed-x86.bat"; DestDir: "{app}"; DestName: "run-emark-installed.bat"; Flags: ignoreversion; Components: main
...
begin
  ...
  begin
    Log('eMark PDF Signer (32-bit) installation completed successfully.');
...
begin
  ...
  begin
    Log('Uninstalling eMark PDF Signer (32-bit)...');
  end;
